      ...
      <div class="flex h-full relative lg:items-center md:justify-center flex-col">
        <div class="banner-wrapper w-full h-full flex flex-col  justify-center">
          <div class="mt-12 mr-0 lg:mr-10">
            ...
            <p class="text-base  mt-5 max-w-[650px] leading-[180%] text-neutral-300 " data-aos="fade-up" data-aos-delay="250">
        ...
        <div class="social flex lg:justify-center lg:flex-col lg:absolute right-0 mt-6 lg:mt-0" data-aos="fade-left" data-aos-delay="350">
