      ...
      <div class="container-personalizado">
        <div class="flex md:justify-between md:items-end md:flex-row flex-col items-center">
          <div class="flex items-center">
            <div class="profile w-[15rem] h-[15rem] border border-primary-pure p-2 rounded-md overflow-hidden">
      ...
      <div class="container-personalizado">
        <div class="flex justify-between">
          <div class="descricao">
            ...
            <div class="texto-descricao max-w-[800px] mt-8">
          ...
          <div class="tecnologias">
            ...
            <ul class="mt-8">
              <li class="text-lg" v-for="tecnologia in projeto.tecnologias" :key="tecnologia">- {{ tecnologia }}</li>
            </ul>
